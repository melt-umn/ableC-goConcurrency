...
void  *printTwice(_template_Channel__builtin_signed_int_  * ch2, signed int  b)
{
...
signed int main()
{

  {
    ...
    (((_spawn_struct_var_110_s)->f0) = (ch));
    (((_spawn_struct_var_110_s)->f1) = 4);
    ((spawn_function)((_spawn_fn_110), ((void *)(_spawn_struct_var_110_s))));
    
    ((printf)("Second Print\n"));
    ((_template_chan_recv__builtin_signed_int_)((ch)));
    return 0;
  }
}
