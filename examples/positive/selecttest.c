...
struct _spawn_arg_110_s {
  signed int f0;
  signed int f1;
  
};
static void  *_spawn_fn_110(void  * _arg_ptr)
{

  {
    struct _spawn_arg_110_s _env = (*((struct _spawn_arg_110_s *)(_arg_ptr)));;
    (((spawn_test1))(((_env).f0), ((_env).f1)));
  }
}
struct _spawn_arg_111_s {
  signed int f0;
  signed int f1;
  
};
static void  *_spawn_fn_111(void  * _arg_ptr)
{

  {
    struct _spawn_arg_111_s _env = (*((struct _spawn_arg_111_s *)(_arg_ptr)));;
    (((spawn_test2))(((_env).f0), ((_env).f1)));
  }
}
typedef signed int _template_param_unused_127;
typedef signed int _template_param_unused_131;
...
static void _template_chan_close__builtin_signed_int_(_template_Channel__builtin_signed_int_  * ch)
{

  {
    ...
    _template_VQueue__builtin_signed_int_  *next_v = ((ch)->vq);;
    while ((!((next_v) == (((void *)0)))))
    {
      {
        (((ch)->vq) = ((next_v)->next));
...
signed int main()
{

  {
    ...
    signed int cow = 25;;
    struct _spawn_arg_110_s  *_spawn_struct_var_110_s = ((malloc)((sizeof(struct _spawn_arg_110_s))));;
    (((_spawn_struct_var_110_s)->f0) = (cow));
    (((_spawn_struct_var_110_s)->f1) = 2);
    ((spawn_function)((_spawn_fn_110), ((void *)(_spawn_struct_var_110_s))));
    
    struct _spawn_arg_111_s  *_spawn_struct_var_111_s = ((malloc)((sizeof(struct _spawn_arg_111_s))));;
    (((_spawn_struct_var_111_s)->f0) = 3);
    (((_spawn_struct_var_111_s)->f1) = 4);
    ((spawn_function)((_spawn_fn_111), ((void *)(_spawn_struct_var_111_s))));
