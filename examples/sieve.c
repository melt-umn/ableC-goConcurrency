...
void  *generate(_template_Channel_builtin__signed_int_  * ch)
{
...
void  *filter(_template_Channel_builtin__signed_int_  * in, _template_Channel_builtin__signed_int_  * out, signed int  prime)
{
...
struct _spawn_arg_39_s {
  _template_Channel_builtin__signed_int_  *f0;
  
};
static void  *_spawn_fn_39(void  * _arg_ptr)
{

  {
    struct _spawn_arg_39_s _env = (*((struct _spawn_arg_39_s *)(_arg_ptr)));;
    (((generate))(((_env).f0)));
  }
}
...
struct _spawn_arg_40_s {
  _template_Channel_builtin__signed_int_  *f0;
  _template_Channel_builtin__signed_int_  *f1;
  signed int f2;
...
signed int main(signed int  argc, char  * * argv)
{

  {
    ...
    struct _spawn_arg_39_s  *_spawn_struct_var_39_s = ((malloc)((sizeof(struct _spawn_arg_39_s))));;
    (((_spawn_struct_var_39_s)->f0) = (ch));
    ((spawn_function)((_spawn_fn_39), ((void *)(_spawn_struct_var_39_s))));
    
    signed int i;;
    for(((i) = 1); ((i) < 1001); ((i)++))
    {
      {
        signed int prime = ((_template_chan_recv_builtin__signed_int_)((ch)));;
        ...
        (((_spawn_struct_var_40_s)->f1) = (ch1));
        (((_spawn_struct_var_40_s)->f2) = (prime));
