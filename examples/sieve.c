...
void  *generate(_template_Channel__builtin_signed_int_  * ch)
{
...
void  *filter(_template_Channel__builtin_signed_int_  * in, _template_Channel__builtin_signed_int_  * out, signed int  prime)
{

  {
    ...
    {
      {
        signed int i = ((_template_chan_recv__builtin_signed_int_)((in)));;
        if ((!((((i) % (prime))) == 0)))
        {
          {
            ((_template_chan_send__builtin_signed_int_)((out), (i)));
          }
        } else {
...
struct _spawn_arg_120_s {
  _template_Channel__builtin_signed_int_  *f0;
  
};
static void  *_spawn_fn_120(void  * _arg_ptr)
{

  {
    struct _spawn_arg_120_s _env = (*((struct _spawn_arg_120_s *)(_arg_ptr)));;
    (((generate))(((_env).f0)));
  }
}
struct _spawn_arg_121_s {
  _template_Channel__builtin_signed_int_  *f0;
  _template_Channel__builtin_signed_int_  *f1;
  signed int f2;
  
};
static void  *_spawn_fn_121(void  * _arg_ptr)
{

  {
    struct _spawn_arg_121_s _env = (*((struct _spawn_arg_121_s *)(_arg_ptr)));;
    (((filter))(((_env).f0), ((_env).f1), ((_env).f2)));
  }
}
...
signed int main(signed int  argc, char  * * argv)
{

  {
    ...
    struct _spawn_arg_120_s  *_spawn_struct_var_120_s = ((malloc)((sizeof(struct _spawn_arg_120_s))));;
    (((_spawn_struct_var_120_s)->f0) = (ch));
    ((spawn_function)((_spawn_fn_120), ((void *)(_spawn_struct_var_120_s))));
    
    signed int i;;
    for(((i) = 1); ((i) < 1001); ((i)++))
    {
      {
        signed int prime = ((_template_chan_recv__builtin_signed_int_)((ch)));;
        ((printf)("The %dth prime is: %d\n", (i), (prime)));
        _template_Channel__builtin_signed_int_  *ch1 = ((_template_chan_open__builtin_signed_int_)());;
        struct _spawn_arg_121_s  *_spawn_struct_var_121_s = ((malloc)((sizeof(struct _spawn_arg_121_s))));;
        (((_spawn_struct_var_121_s)->f0) = (ch));
        (((_spawn_struct_var_121_s)->f1) = (ch1));
        (((_spawn_struct_var_121_s)->f2) = (prime));
        ((spawn_function)((_spawn_fn_121), ((void *)(_spawn_struct_var_121_s))));
